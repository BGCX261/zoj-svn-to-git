            ...
            <input type="hidden" name="lastId" value="-1">
                ...
                <table class="list">
                    ...
                    <tr class="<%=i % 2 == 0 ? "rowOdd" : "rowEven"%>">
                        ...
                        String reviewStatus="&nbsp;";
                        String classtext="";
                        if(submission.getJudgeReply().getId()==5) {
                        if(submission.getJudgeComment()!=null) {
                        if("Yes".equals(submission.getJudgeComment())) {
                        		classtext="judgeReplyAC";
                        		reviewStatus = "Yes";
                        	} else if("No".equals(submission.getJudgeComment())) {
                        		classtext="judgeReplyOther";
                        		reviewStatus = "No";
                        	} else {
                        		classtext="judgeReplyOther";
                        		reviewStatus = "Wait";
